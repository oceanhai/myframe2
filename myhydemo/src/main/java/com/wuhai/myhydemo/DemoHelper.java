...
import com.wuhai.myhydemo.receiver.CallReceiver;
import com.wuhai.myhydemo.receiver.HeadsetReceiver;
import com.wuhai.myhydemo.ui.ChatActivity;
import com.wuhai.myhydemo.ui.ECMainActivity;
import com.wuhai.myhydemo.ui.VideoCallActivity;
import com.wuhai.myhydemo.ui.VoiceCallActivity;
import com.wuhai.myhydemo.utils.PreferenceManager;
...
//	private UserProfileManager userProManager;//TODO 用户相关管理？！
	...
	public boolean isVoiceCalling;//TODO wuhai
    public boolean isVideoCalling;//TODO wuhai

	private String username;

    private Context appContext;

    //TODO 全局监听广播  接受语音和视频聊天
    private CallReceiver callReceiver;

//    private InviteMessgeDao inviteMessgeDao;//TODO 邀请好友提醒  为啥这些要记本地bd?
//    private UserDao userDao;//TODO 切换用户  为啥这些要记本地bd?  这个不是可以直接通过后台取到吗？
...
//			getUserProfileManager().init(context);
	        ...
	        initDbDao();//TODO 为啥要本地db  先把里面内容置空
		}
	}
...
//                userDao.saveContact(user);//TODO wuhai  先不搞数据库
            }
...
//    }
    ...
    protected void onUserException(String exception){
        ...
        Intent intent = new Intent(appContext, ECMainActivity.class);
