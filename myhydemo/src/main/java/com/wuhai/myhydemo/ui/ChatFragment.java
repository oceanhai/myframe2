...
import com.wuhai.myhydemo.DemoHelper;
import com.wuhai.myhydemo.R;
import com.wuhai.myhydemo.domain.EmojiconExampleGroupData;
import com.wuhai.myhydemo.domain.RobotUser;
import com.wuhai.myhydemo.widget.ChatRowConferenceInvitePresenter;
import com.wuhai.myhydemo.widget.ChatRowLivePresenter;
import com.wuhai.myhydemo.widget.EaseChatRecallPresenter;
import com.wuhai.myhydemo.widget.EaseChatVoiceCallPresenter;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentHelper {
    ...
    private static final int REQUEST_CODE_GROUP_DETAIL = 13;//群或聊天室
    ...
    protected void setUpView() {
        ...
        if (chatType == Constant.CHATTYPE_SINGLE) { //TODO wuhai ?
...
//                }
        ...
        if(chatType == EaseConstant.CHATTYPE_GROUP){//TODO 群聊  @ 选择联系人，跳转到选择联系人界面
...
//            });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_CONTEXT_MENU) {
            ...
            case ContextMenuActivity.RESULT_CODE_FORWARD: // forward  TODO 转发？
//                Intent intent = new Intent(getActivity(), ForwardMessageActivity.class);
//                intent.putExtra("forward_msg_id", contextMenuMessage.getMsgId());
//                startActivity(intent);
                break;
            case ContextMenuActivity.RESULT_CODE_RECALL://recall 撤回
...
//            switch (resultCode) {
//                case GroupDetailsActivity.RESULT_CODE_SEND_GROUP_NOTIFICATION://群组详情
...
//        }
    ...
    @Override
    public void onEnterToChatDetails() {//TODO titlebar 右侧 群或聊天室
...
//        }
    ...
    @Override
    public void onAvatarClick(String username) {//TODO 个人详情页
