 ...
 * 描述：
 */
class LotteryCreateHolder(binding: ViewDataBinding, context: Context?) : BaseDataBindingHolder<Lottery?>(binding, context) {
...
//            }
//        });
        binding.selectCb.isChecked = mData!!.isSelected
    }

    companion object {
        const val TAG = "LotteryCreateHolder"
    }
