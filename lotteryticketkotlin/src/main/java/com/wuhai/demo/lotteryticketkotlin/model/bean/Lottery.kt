...
class Lottery : BaseBean {
     ...
     */
    @Transient
    var isSelected = false //是否是选中

    @Generated(hash = 836306236)
    constructor(lottery_id: String?, lottery_type: String?, lottery_name: String?,
                lottery_red_ball: String?, lottery_blue_ball: String?,
