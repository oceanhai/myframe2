...
//    }
    ...
    public void onNotificationMessageArrived(Context context, GTNotificationMessage message) {
        ...
        //创建删除通知时发送的广播
        Intent deleteIntent = new Intent(context,DemoIntentService.class);
        deleteIntent.setAction(ACTION_DELETE);
        PendingIntent deletePendingIntent = PendingIntent.getService(context,0,deleteIntent,0);
        //创建通知
        Notification.Builder nb = new Notification.Builder(context,"low")
                //设置通知左侧的小图标
