...
public class X5WebViewClient extends WebViewClient {
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
        ...
        //从url中获取是否要加标题的参数
//        Map<String, String> params = UrlUtils.parseParams(url);
//        boolean isHasStateColor = params.containsKey("stateColor");
//        if (isHasStateColor) {
//            String stateColor = params.get("stateColor");
//            LogUtils.d("stateColor","----------stateColor---------");
//        }
...
//        if (isHasStateColor) {
//            String stateColor = params.get("stateColor");
//            LogUtils.d("stateColor","----------stateColor------222---");
//        }
    ...
    public void onPageFinished(WebView view, String url) {
        ...
        if(webListener != null){
            ...
            if (!X5WebUtils.isConnected(webView.getContext())) {
                //显示异常页面
                webListener.showErrorView(X5WebUtils.ErrorMode.NO_NET);
            }
        }
