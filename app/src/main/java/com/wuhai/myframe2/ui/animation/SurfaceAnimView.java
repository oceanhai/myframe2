...
public class SurfaceAnimView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        Log.e(SurfaceBean.TAG, "surfaceCreated");
        if (drawThread == null) {
            drawThread = new DrawThread();
        }
        drawThread.start();
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        Log.e(SurfaceBean.TAG, "surfaceChanged");
    }

    @Override
    public void surfaceDestroyed(SurfaceHolder holder) {
        Log.e(SurfaceBean.TAG, "surfaceDestroyed");
        if (drawThread != null) {
            ...
            while (isRun) {
                ...
                try {
                    synchronized (surfaceHolder) {
                        //锁定整个 SurfaceView 对象，获取该 Surface 上的 Canvas
