...
import com.wuhai.myframe2.ui.slidingfinish.view.SlideRightOrDownLayout;
 ...
 * 
 */
public class SlideRightOrDownActivity extends BaseActivity2 {
	protected SlideRightOrDownLayout layout;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(canSlidingFinish()){
			layout = (SlideRightOrDownLayout) LayoutInflater.from(this).inflate(
					R.layout.layout_slide_right_or_down, null);
