...
/**
 * layout_flexBasisPercent 属性(控件内view)
 */
public class RecyclerViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ac_flexbox_recycler_view);
...
//        });
        ...
        mRecyclerView.setAdapter(new CommonAdapter<Integer>(this, R.layout.item_flexbox, mDatas)
        {
            @Override
