package com.wuhai.myframe2.ui.countdownview;
...
public class CountdownViewActivity extends AppCompatActivity implements CountdownView.OnCountdownEndListener {
    ...
    public static void startActivity(Context context) {
        Intent intent = new Intent(context, CountdownViewActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ac_countdown_view);
        ...
        findViewById(R.id.btn_toListViewActivity).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CountdownViewActivity.this, ListViewActivity.class));
            }
        });
        ...
        findViewById(R.id.btn_toRecyclerViewActivity).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CountdownViewActivity.this, RecyclerViewActivity.class));
            }
        });
    }
