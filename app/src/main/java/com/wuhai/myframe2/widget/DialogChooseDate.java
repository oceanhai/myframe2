package com.wuhai.myframe2.widget;
...
import com.wuhai.myframe2.widget.wheel.adapters.AbstractWheelTextAdapter;
import com.wuhai.myframe2.widget.wheel.views.OnWheelChangedListener;
import com.wuhai.myframe2.widget.wheel.views.OnWheelScrollListener;
import com.wuhai.myframe2.widget.wheel.views.WheelView;
...
/**
 * Created by wuhai on 2017/3/9 0009 17:56.
 * 描述：日期选择对话框
 */
public class DialogChooseDate extends Dialog implements View.OnClickListener {
	...
	private List<String> arry_years = new ArrayList<String>();
	private List<String> arry_months = new ArrayList<String>();
	private List<String> arry_days = new ArrayList<String>();
	...
	public void onClick(View v) {
		...
		}else if (v.equals(vChangeBirthChild)) {
			return;
		} else {
			dismiss();
		}
