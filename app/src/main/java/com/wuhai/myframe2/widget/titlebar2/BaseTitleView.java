package com.wuhai.myframe2.widget.titlebar2;
...
//                    ToastUtils.show("点击了" + btn_right.getText().toString());
    ...
    private boolean isListenerInit() {
        if (null == titleViewListener) {
            Log.e("BaseTitleView","please set titleView listener");
            return false;
        }
        return true;
    }
...
//     * @param background
//     */
//    protected void setLeftBtnBackground(Drawable background) {
...
//     * @param background
//     */
//    protected void setRightBtnBackground(Drawable background) {
//        btn_right.setBackground(background);
//    }
//
//    /**
//     * 设置标题文字大小
//     * @param textSizeSp 单位sp
//     */
//    protected void setTitleTvSize(int textSizeSp) {
//        tv_title.setTextSize(TypedValue.COMPLEX_UNIT_SP, textSizeSp);
//    }
//
//    /**
//     * 设置标题文字颜色
//     * @param textColor int
//     */
//    protected void setTitleTvColor(int textColor) {
...
//     * @param textColor int
//     */
//    protected void setBtnTvColor(int textColor) {
//        tv_title.setTextColor(textColor);
//    }
//
//
...
//     * @param textSizeSp 单位sp
//     */
//    protected void setBtnTvSize(int textSizeSp){
//        btn_left.setTextSize(TypedValue.COMPLEX_UNIT_SP,textSizeSp);
//        btn_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, textSizeSp);
//    }
