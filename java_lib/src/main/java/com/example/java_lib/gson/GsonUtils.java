...
public final class GsonUtils {
     ...
     * @return
     */
    public JsonElement getElement(List list){
     ...
     * @return
     */
    public JsonArray getJsonarray(String list){
        JsonParser parser = new JsonParser();
        return parser.parse(list).getAsJsonArray();
    }

    public static class StringDefaultAdapter implements JsonDeserializer<String> {
        @Override
