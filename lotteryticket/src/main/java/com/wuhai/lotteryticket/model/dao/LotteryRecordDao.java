...
/** 
 * DAO for table "lottery_record".
*/
public class LotteryRecordDao extends AbstractDao<LotteryRecord, String> {

    public static final String TABLENAME = "lottery_record";

    /**
     * Properties of entity LotteryRecord.<br/>
    ...
    public LotteryRecordDao(DaoConfig config) {
        super(config);
    }
    
    public LotteryRecordDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"lottery_record\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"lottery_record\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, LotteryRecord entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, LotteryRecord entity) {
        stmt.clearBindings();
    ...
    @Override
    public LotteryRecord readEntity(Cursor cursor, int offset) {
        LotteryRecord entity = new LotteryRecord( //
    ...
    @Override
    public void readEntity(Cursor cursor, LotteryRecord entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(LotteryRecord entity, long rowId) {
        return entity.getLottery_id();
    }
    
    @Override
    public String getKey(LotteryRecord entity) {
        if(entity != null) {
            return entity.getLottery_id();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(LotteryRecord entity) {
